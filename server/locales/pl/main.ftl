...
user-online = { $player } się zalogowało.
user-offline = { $player } się wylogował.
...
missing-players = nie można przywrucić stołu z uwagi na brak następujących graczy: { $players }
