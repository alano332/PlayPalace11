...
chaosbear-card-backward = Толчёк назад! { $player } отступает на клетку { $position }.
...
chaosbear-bear-feast = Медведь теряет 3 единицы энергии, полакомившись его плотью!
